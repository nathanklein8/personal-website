...
<section
	...
	class="flex min-h-[75vh] flex-col items-center justify-center gap-y-12 bg-secondary/80 py-16"
>
	<h1 class="font-code text-center text-lg md:text-3xl">Photography</h1>

	<div class="border-2 border-foreground p-32">under construction</div>
...
<section id="footer" class="h-16 bg-secondary/80 flex flex-col justify-center">
